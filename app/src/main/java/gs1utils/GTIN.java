...
import static gs1utils.Internals.*;
...
public final class GTIN {
    ...
    public static boolean isGTIN(String gtin) {
        return Internals.isDigits(gtin) && (gtin.length() == 14 || gtin.length() == 13 || gtin.length() == 12 || gtin.length() == 8);
    }
    ...
    public static boolean isGTIN14(String gtin) {
        return Internals.isDigits(gtin) && gtin.length() == 14;
    }
    ...
    public static boolean isGTIN13(String gtin) {
        return Internals.isDigits(gtin) && gtin.length() == 13;
    }
    ...
    public static boolean isGTIN12(String gtin) {
        return Internals.isDigits(gtin) && gtin.length() == 12;
    }
    ...
    public static boolean isGTIN8(String gtin) {
        return Internals.isDigits(gtin) && gtin.length() == 8;
    }
    ...
    public static String toGTIN14(String gtin) {
        ...
        validateFormat(gtin);
        return Internals.leftPadWithZeroes(gtin, 14);
    }
    ...
    public static String toGTIN8(String gtin) {
        ...
        validateFormat(gtin);
        if (gtin.length() > 8) {
            if (!Internals.startsWithNZeroes(gtin, gtin.length() - 8)) {
